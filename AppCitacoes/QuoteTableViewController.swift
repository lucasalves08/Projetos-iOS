...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "moveToDetails" , sender: selectedQuote)
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let quoteViewControler = segue.destination as? QuoteDetailsViewController {
            if let selectedQuote = sender as? String {
                quoteViewControler.quote = selectedQuote
            }
        }
